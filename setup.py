...
setup(
    ...
    scripts=['Utils/reduce_action', 'Utils/find_best_comparisons', 'Utils/make_photometry_catalogue', 'Utils/postprocess_action', 'Utils/photpack',
            'Utils/process_night', 'Utils/process_night_wrapper'],
